...
{
    public static class RecipeBludgeonBodyPartPatches
    {
        [HarmonyPatch("WarCrimesExpanded2.Recipe_BludgeonBodyPart", "ApplyOnPawn")]
        public static class ApplyOnPawn
        {
            public static bool Prepare()
            {
                return WarCrimesExpandedCompat.ShouldPatchType("WarCrimesExpanded2.Recipe_BludgeonBodyPart");
            }
